    ...
    <main class="main-content  mt-0">
        <section class="min-vh-100 mb-8">
            <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
                style="background-image: url('/template/assets/img/auth-img/hero-register-img.png');">
                <span class="mask bg-gradient-dark opacity-6"></span>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            <h1 class="text-white mb-2 mt-5">Selamat Datang</h1>
                            <p class="text-lead text-white">Silahkan daftarkan diri anda untuk menggunakan fitur yang
                                lebih lengkap.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form action="/sign-up/store" role="form text-left" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" placeholder="Name" aria-label="Name"
                                            aria-describedby="email-addon" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                            class="btn btn-gradient-primary text-white w-100 my-4 mb-2">Sign
                                            Up</button>
                                    </div>
                                    <p class="text-sm mt-3 mb-0">Already have an account? <a href="/sign-in"
