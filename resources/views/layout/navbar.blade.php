            ...
            <ul class="navbar-nav justify-content-end">
                @auth
                    <li class="nav-item d-flex align-items-center">
                        <a href="/my/profile" class="nav-link text-body font-weight-bold px-0">
                            ...
                            @else
                                <img src="{{ auth()->user()->avatar }}" width="30px" class="rounded-pill mx-1"
                                    alt="avatar">
                            @endif
                        </a>
                    </li>
                    <li class="nav-item d-flex mx-3 align-items-center">
                        <a href="/my/book/add-book" class="nav-link text-body font-weight-bold px-0"
                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tambah Buku">
                            <i
                                class="fa-solid fa-plus {{ Request::is('my/book/add-book') ? 'text-primary-custom' : '' }}"></i>
                            <span
                                class="d-sm-inline d-none {{ Request::is('my/book/add-book') ? 'text-primary-custom' : '' }}">New
                                Book</span>
                        </a>
                    </li>
